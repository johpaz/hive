...
docker save johpaz/hive:0.0.38 -o /media/usb/hive-image.tar
```
...
|------------|---------|------------------|
| Linux x64 | `hive-v0.0.38-linux-x64` | [Descargar](https://github.com/johpaz/hive/releases/latest/download/hive-v0.0.38-linux-x64) |
| Linux ARM64 (Raspberry Pi, etc.) | `hive-v0.0.38-linux-arm64` | [Descargar](https://github.com/johpaz/hive/releases/latest/download/hive-v0.0.38-linux-arm64) |
| macOS Apple Silicon (M1/M2/M3/M4) | `hive-v0.0.38-macos-arm64` | [Descargar](https://github.com/johpaz/hive/releases/latest/download/hive-v0.0.38-macos-arm64) |
| macOS Intel | `hive-v0.0.38-macos-x64` | [Descargar](https://github.com/johpaz/hive/releases/latest/download/hive-v0.0.38-macos-x64) |
| Windows x64 | `hive-v0.0.38-windows-x64.exe` | [Descargar](https://github.com/johpaz/hive/releases/latest/download/hive-v0.0.38-windows-x64.exe) |
...
Descarga [`hive-v0.0.38-windows-x64.exe`](https://github.com/johpaz/hive/releases/latest/download/hive-v0.0.38-windows-x64.exe) desde GitHub o desde [hiveagents.io](https://www.hiveagents.io/#installation).
...
```powershell
.\hive-v0.0.38-windows-x64.exe start
```
