...
docker pull johpaz/hive:0.0.19

# Exportar a archivo tar (cabe en cualquier USB de 512 MB+)
docker save johpaz/hive:0.0.19 -o /media/usb/hive-image.tar
```
...
|------------|---------|------------------|
| Linux x64 | `hive-v0.0.19-linux-x64` | [Descargar](https://github.com/johpaz/hive/releases/latest/download/hive-v0.0.19-linux-x64) |
| Linux ARM64 (Raspberry Pi, etc.) | `hive-v0.0.19-linux-arm64` | [Descargar](https://github.com/johpaz/hive/releases/latest/download/hive-v0.0.19-linux-arm64) |
| macOS Apple Silicon (M1/M2/M3/M4) | `hive-v0.0.19-macos-arm64` | [Descargar](https://github.com/johpaz/hive/releases/latest/download/hive-v0.0.19-macos-arm64) |
| macOS Intel | `hive-v0.0.19-macos-x64` | [Descargar](https://github.com/johpaz/hive/releases/latest/download/hive-v0.0.19-macos-x64) |
| Windows x64 | `hive-v0.0.19-windows-x64.exe` | [Descargar](https://github.com/johpaz/hive/releases/latest/download/hive-v0.0.19-windows-x64.exe) |
...
curl -L -o hive https://github.com/johpaz/hive/releases/latest/download/hive-v0.0.19-linux-x64
...
```bash
# 1. Descargar
curl -L -o hive https://github.com/johpaz/hive/releases/latest/download/hive-v0.0.19-macos-arm64
...
```bash
curl -L -o hive https://github.com/johpaz/hive/releases/latest/download/hive-v0.0.19-macos-x64
chmod +x hive
xattr -d com.apple.quarantine hive
curl -L https://github.com/johpaz/hive/releases/latest/download/ui-dist.tar.gz \
  | tar -xz --one-top-level=ui-dist
...
Descarga [`hive-v0.0.19-windows-x64.exe`](https://github.com/johpaz/hive/releases/latest/download/hive-v0.0.19-windows-x64.exe) desde GitHub o desde [hiveagents.io](https://www.hiveagents.io/#installation).
...
```powershell
.\hive-v0.0.19-windows-x64.exe start
```
...
Move-Item .\hive-v0.0.19-windows-x64.exe C:\Windows\System32\hive.exe
...
```bash
cp hive-v0.0.19-linux-x64 /media/usb/hive
