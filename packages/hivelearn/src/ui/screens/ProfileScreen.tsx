    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-blue-400">HiveLearn</h1>
        ...
        <div className="bg-gray-900 rounded-2xl border border-gray-800 p-6 space-y-5">
          ...
          <div>
            ...
            <input
              className="w-full rounded-lg bg-gray-800 border border-gray-700 px-3 py-2 text-white text-sm focus:border-blue-500 outline-none"
          ...
          <div>
            <label className="block text-xs text-gray-400 mb-1">
              Edad: <span className="text-blue-400 font-bold">{form.edad} años</span>
          ...
          <button
            ...
            className="w-full rounded-xl bg-blue-600 py-3 text-sm font-bold text-white hover:bg-blue-500 disabled:opacity-40 disabled:cursor-not-allowed transition-all"
          >
            Continuar →
          </button>
        </div>
