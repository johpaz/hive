/**
 * Schedule Tools for Coordinator Agent
 * 
...
const log = logger.child("ScheduleTools");
...
export const schedulePauseTool: Tool = {
...
// ─── hive.schedule.trigger ───────────────────────────────────────────────────

export const scheduleTriggerTool: Tool = {
...
// ─── hive.schedule.history ───────────────────────────────────────────────────

export const scheduleHistoryTool: Tool = {
