...
const INDEXES: IndexSpec[] = [
  ...
  { collection: "agentRuns", field: "specialist_id" },
  ...
  { collection: "proofPackets", field: "specialist_id" },
  { collection: "verifications", field: "run_id" },
  { collection: "verifications", field: "task_id" },
  { collection: "verifications", field: "executor_specialist_id" },
  { collection: "verifications", field: "status" },
  { collection: "specialistProposals", field: "specialist_id" },
  { collection: "specialistProposals", field: "status" },
  { collection: "specialistProposals", field: "type" },
  ...
  { collection: "tasks", field: "specialist_id" },
